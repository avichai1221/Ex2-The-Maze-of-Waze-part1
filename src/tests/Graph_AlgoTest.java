...
public class Graph_AlgoTest {
	...
	public void testInitGraph()
	{
	    ...
	    g.init(a1);
		assertEquals(g.getV().toString(), "[--key:2,point3D:null,weight:2.0,info:null,tag:2, --key:4,point3D:null,weight:333.0,info:null,tag:333]");
		assertEquals(g.getE(2).toString(), "[--src:2,dest:54,weight:4.0,info:null,tag:0]");
